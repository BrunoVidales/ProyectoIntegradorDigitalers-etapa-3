...
const NavbarSecundario = () => {
  ...
  return (
    <div className="head  d-flex justify-content-center align-items-center mb-5">
        <nav className="navbar navbar-expand-lg container p-3">
            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarNav"> 
                <ul className="m-0 navbar-nav d-flex justify-content-between align-items-center w-50 ul-modo"> 
                    <li>
